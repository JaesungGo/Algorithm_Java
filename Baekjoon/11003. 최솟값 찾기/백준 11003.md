...
//        int startTime = (int)System.currentTimeMillis();
        ...
        // 윈도우 역할의 큐 (초기값 null?)
        Queue<Integer> windowQueue = new ArrayDeque<>(numL);
        ...
        for(int k=1; k< arrAnswer.length; k++){
            System.out.print(arrAnswer[k] + " ");
        }

//        System.out.println("수행 시간" + (startTime - (int)System.currentTimeMillis()));
...
class Main {
    ...
    public static void main(String[] args) {
        ...
        // 윈도우 역할의 큐 (초기값 null?)
        Queue<Integer> windowQueue = new PriorityQueue<>(numL);
        ...
        while( i <= numN ){
           ...
           if( i > numL ){
               windowQueue.remove(arrInt[i-numL]);
               windowQueue.add(arrInt[i]);
           }

            arrAnswer[i] = windowQueue.peek();
            i++;
        }
